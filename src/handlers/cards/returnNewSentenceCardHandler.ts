...
import { returnNewSentenceCard } from "../../db/bin/cards/returnNewSentnceCard";

export const returnNewSentenceCardHandler = async (
  req: express.Request,
  ...
  try {
    ...
    const card = await returnNewSentenceCard(req);
